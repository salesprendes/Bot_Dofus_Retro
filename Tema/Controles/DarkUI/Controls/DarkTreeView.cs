...
using Bot_Dofus_Retro.DarkUI.Extensions;
...
namespace Bot_Dofus_Retro.DarkUI.Controls
{
    public class DarkTreeView : DarkScrollView
    {
        ...
        private void Nodes_TextChanged(object sender, EventArgs e) => UpdateNodes();
        ...
        private void LoadIcons()
        {
            ...
            _nodeClosed = Properties.Resources.node_closed_empty.SetColor(Colors.LightText);
            _nodeClosedHover = Properties.Resources.node_closed_empty.SetColor(Colors.BlueHighlight);
            _nodeClosedHoverSelected = Properties.Resources.node_closed_full.SetColor(Colors.LightText);
            _nodeOpen = Properties.Resources.node_open.SetColor(Colors.LightText);
            _nodeOpenHover = Properties.Resources.node_open.SetColor(Colors.BlueHighlight);
            _nodeOpenHoverSelected = Properties.Resources.node_open_empty.SetColor(Colors.LightText);
        }
        ...
        protected override void PaintContent(Graphics g) => Nodes.ForEach(nodo => DrawNode(nodo, g));
