...
namespace Bot_Dofus_Retro.DarkUI.Docking
{
    ...
    public class DarkDockGroup : Panel
    {
        ...
        public void AddContent(DarkDockContent dockContent)
        {
            ...
            dockContent.AparienciaCambiada += DockContent_AparienciaCambiada;
        ...
        public void RemoveContent(DarkDockContent dockContent)
        {
            ...
            foreach (DarkDockContent otherContent in _contents)
            {
                if (otherContent.Order > order)
                    otherContent.Order--;
            }
        ...
        private void DockContent_AparienciaCambiada(DarkDockContent contenido)
        {
            DockPanel.get_Evento_Contenido_Cambiado(contenido);
        }
        ...
        private void UpdateTabArea()
        {
            ...
            switch (DockArea)
            {
                case DarkDockArea.Document:
                    ...
                    Padding = new Padding(0, DockPanel.activar_tabs ? size : 0, 0, 0);
        ...
        private void BuildTabs()
        {
            ...
            var closeButtonSize = Properties.Resources.close.Width;
        ...
        private Point PointToTabArea(Point point) => new Point(point.X - _tabArea.Offset, point.Y);
        private Rectangle RectangleToTabArea(Rectangle rectangle) => new Rectangle(PointToTabArea(rectangle.Location), rectangle.Size);
        ...
        private void PaintDocumentTab(Graphics g, DarkDockTab tab)
        {
            ...
            {
                var textRect = new Rectangle(tabRect.Left + 5 + xOffset, tabRect.Top, tabRect.Width - 7 - 5 - xOffset, tabRect.Height);
